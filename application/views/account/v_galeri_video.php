...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
       ...
       <div class="content">
            <?php echo form_open_multipart('video/aksi_simpan');?>
                ...
                <input type="submit" value="upload" />
                    ...
                    <?php
                        if(is_array($daftar_video)){
                            foreach ($daftar_video as $dav) {
                            ?>
                            <div class="left-box" style="min-height:100px; min-width: 135%;">
                            
                                <h2><?php echo $dav->judul_video ?></h2>
                                <left>
                                    <video controls="controls" id="video1" width="50%" 
                                        data-setup='{"controls" : true, "autoplay" : false, "preload" : "auto"}'>
                                        <source src="<?php echo base_url()?>assets/galeri/video/<?php echo $dav->video?>" type='video/mp4' />
                                        <source src="<?php echo base_url()?>assets/galeri/video/<?php echo $dav->video?>" type='video/ogg' />
                                        <source src="<?php echo base_url()?>assets/galeri/video/<?php echo $dav->video?>" type='video/webm' />
                                        <source src="<?php echo base_url()?>assets/galeri/video/<?php echo $dav->video?>" type='video/avi' />
                                        <source src="<?php echo base_url()?>assets/galeri/video/<?php echo $dav->video?>" type='video/flv' />
                                        <source src="<?php echo base_url()?>assets/galeri/video/<?php echo $dav->video?>" type='video/wmv' />
                                    </video>
                                </left>
                                <hr>
                                <hr>
