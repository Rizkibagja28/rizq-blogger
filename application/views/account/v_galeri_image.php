...
<body>
	...
	<?php echo form_open_multipart('image/aksi_simpan');?>
    </br>
	...
	<input type="submit" value="Upload" />
			...
			<hr>
				<?php
					if(is_array($daftar_gambar)){
						foreach ($daftar_gambar as $dag) {
							?>
							<img src="<?php echo base_url();?>assets/galeri/gambar/<?php echo $dag->gambar ;?>">
