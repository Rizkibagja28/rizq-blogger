...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Daftar Artikel</h1>
            </div>
        </div><!--/.row-->
				...
				<div class="tables">
					<table class="table table-hover"> 
						...
						<tbody> 
							<?php
								$no = 1;
								if(is_array($list_artikel)){
									foreach ($list_artikel as $la) {
							?>
							<tr> 
								<th><?php echo $no++ ?></th> 
								<td><?php echo $la->judul ?></td>
                                <td><?php echo $la->kategori ?></td> 
								<td><?php echo $la->tanggal_post ?></td>
								<td> | 
									<a href="<?php echo base_url()?>index.php/list_artikel/hapus/<?php echo $la->id_artikel ?>">
