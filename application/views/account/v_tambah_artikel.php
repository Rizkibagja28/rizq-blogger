    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Buat Artikel Baru</li>
            </ol>
        </div><!--/.row-->
        
        <div class="row">
            <div class="col-lg-10">
                <h1 class="page-header">Buat Artikel Baru</h1>
            </div>
        </div><!--/.row-->
        ...
        <div class="row">
            <div class="col-md-11">
                <div class="panel panel-default chat">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url('index.php/tambah_artikel/aksi_simpan')?>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary col-sm-12" style="background-color: #1A2226;">Lampirkan</button>
                            </div>
